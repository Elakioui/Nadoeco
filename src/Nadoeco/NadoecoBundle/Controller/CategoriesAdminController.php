...
use Nadoeco\NadoecoBundle\Form\CategoriesType;
...
class CategoriesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NadoecoNadoecoBundle:Categories')->findAll();

        return $this->render('NadoecoNadoecoBundle:administration:categories/layout/index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('NadoecoNadoecoBundle:administration:categories/layout/new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NadoecoNadoecoBundle:Categories')->find($id);
        ...
        return $this->render('NadoecoNadoecoBundle:administration:categories/layout/show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('NadoecoNadoecoBundle:administration:categories/layout/edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('categoriesAdmin'));
    }
